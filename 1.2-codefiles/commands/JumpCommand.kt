    ...
    override fun onCommand(sender: CommandSender, command: Command,label: String, args: Array<out String>): Boolean {
        ...
        if(sender is Player) {
            if(sender.isOp) {
                ...
                sender.sendMessage((Component.text("You successfully jumped").color(TextColor.color(0,255,75))))
                sender.velocity = sender.velocity.add(org.bukkit.util.Vector(0.0, 10.0, 0.0))
            }
            else{
